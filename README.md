...
## AWX + Ansible (Автоматизация)

### AWX используется как централизованная система автоматизации.

Реализовано:

подключение Git-репозитория
выполнение playbooks через Job Templates
централизованное управление конфигурацией

С помощью Ansible автоматизировано:

установка пакетов и базовая настройка системы
создание и управление пользователями
настройка мониторинга (Node Exporter)
настройка логирования (Alloy)
развертывание Loki
выполнение backup задач

### Управление пользователями

## С помощью Ansible (AWX) реализовано управление локальными пользователями.
...
Это соответствует нормам информационной безопасности
